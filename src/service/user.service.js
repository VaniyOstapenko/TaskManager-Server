const { getAllUsersDB, createUsersDB, getUserByIdDB, updateUserByIdDB, patchUserByIdDB } = require('../repository/user.repository');
...
module.exports = { getAllUsers, createUsers, getUserById, updateUserById, patchUserById };